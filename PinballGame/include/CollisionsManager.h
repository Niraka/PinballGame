/**
The CollisionsManager is a map-independant class for performing collision detection
...
class CollisionsManager
{
	public:
		...
		std::list<Collidable*> getPotentialCollidables(Vector2D vPos, float fHalfWidth, float fHalfHeight);
